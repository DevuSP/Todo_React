    ...
    return (
        ...
        <form>
            <div className="bg-blue-300/60 flex flex-col rounded-lg px-8 py-7 w-96">
                <h1 className="text-3xl text-center mb-8 font-semibold">Login</h1>
                ...
                <label className="mb-1 ml-1 text-black hover:text-blue-800  hover:underline inline-block"><NavLink to="/">Create new account.</NavLink></label>
            </div>
        </form>
    </div>
    )
